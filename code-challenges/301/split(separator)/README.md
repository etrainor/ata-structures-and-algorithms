![CF](https://i.imgur.com/7v5ASc8.png)  slice(), splice(), split(), join()
=======
## Overview
...
The `join(char)` array method will iterate an array and create a string by concatenating the value of each element in the array with the `char` that you specifiy.
- The original arry is not modified
...
**slice()** -- Find elements within an arry
...
- 3 params: Start Index, # of Elements to Remove, Replacement Value
